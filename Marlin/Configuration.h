...
#define STRING_VERSION_CONFIG_H __DATE__ "31/08/2016 1452h" __TIME__ // build date and time
#define STRING_CONFIG_H_AUTHOR "(Fabien BERNARD, reprap.pt)" // Who made the changes.
